...
<article class="post">
	<header>
		...
		<div class="meta">
			...
			<a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" class="author-fut-imp"><span class="name"><?php echo esc_html( get_the_author() ); ?></span><?php echo get_avatar( get_the_author_meta( 'ID' ), 36 ); ?></a>
		</div>
	</header>
	...
	<footer>
		<ul class="actions">
			<li><a href="<?php esc_url( the_permalink() ); ?>" class="button big"><?php _e( 'Lire la suite', 'future-imperfect' ); ?></a></li>
		</ul>
		<ul class="stats">
