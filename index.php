		...
		if ( have_posts() ) :
			...
			endwhile;
				...
				echo '<ul class="actions pagination">' . "\n";
					echo '<li><a href="' . esc_url( get_previous_posts_page_link() ) . '" class="' . esc_attr( $prev_disable ) . 'button big previous">Page Précédente</a></li>' . "\n";
					echo '<li><a href="' . esc_url( get_next_posts_page_link() ) . '" class="' . esc_attr( $next_disable ) . 'button big next">Page Suivante</a></li>' . "\n";
				echo '</ul>' . "\n";
